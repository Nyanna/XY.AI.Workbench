...
from cgen.model.nodes import AnyDictionaryNode, DictionaryNode, EnumNode, ListNode, RefNode
from cgen.naming.identifiers import content_type_short_name
from cgen.naming.names import derive_class_names
from cgen.naming.packages import (
    Site,
    anonymous_package,
