...
class GitHubBridge(McpBridge):
    ...
    def build_client(self, config: ServerConfig) -> McpClient:
        ...
        if not pat:
            raise McpClientError('GitHub PAT is not configured (set MCPC_GITHUB_PAT).')
        return McpClient(config.github_mcp_url, headers={'Authorization': f'Bearer {pat}'})
...
def github_get_tree(owner: str, repo: str, tree_sha: str | None=None, recursive: bool | None=None, path_filter: str | None=None) -> dict:
...
def github_search_commits(query: str, sort: str | None=None, order: str | None=None, perPage: int | None=None, page: int | None=None) -> dict:
    ...
    Args:
        ...
        page: Page number (min 1).
    """
    return _get_bridge().call('search_commits', compact(query=query, sort=sort, order=order, perPage=perPage, page=page))

def github_search_repos(query: str, sort: str | None=None, order: str | None=None, perPage: int | None=None, page: int | None=None, minimal_output: bool | None=None) -> dict:
...
def github_issue_read(owner: str, repo: str, issue_number: int, method: str, page: int | None=None, perPage: int | None=None) -> dict:
...
def github_list_issues(owner: str, repo: str, state: str | None=None, labels: list[str] | None=None, since: str | None=None, perPage: int | None=None, after: str | None=None) -> dict:
...
def github_search_issues(query: str, owner: str | None=None, repo: str | None=None, sort: str | None=None, order: str | None=None, perPage: int | None=None, page: int | None=None) -> dict:
...
def github_get_discussion(owner: str, repo: str, discussionNumber: int) -> dict:
    ...
    """
    return _get_bridge().call('get_discussion', compact(owner=owner, repo=repo, discussionNumber=discussionNumber))

def github_get_discussion_comments(owner: str, repo: str, discussionNumber: int, includeReplies: bool | None=None, perPage: int | None=None, after: str | None=None) -> dict:
...
def github_list_discussions(owner: str, repo: str | None=None, category: str | None=None, orderBy: str | None=None, direction: str | None=None, perPage: int | None=None, after: str | None=None) -> dict:
...
def github_pr_read(owner: str, repo: str, pullNumber: int, method: str, page: int | None=None, perPage: int | None=None, after: str | None=None) -> dict:
...
def github_list_prs(owner: str, repo: str, state: str | None=None, base: str | None=None, sort: str | None=None, direction: str | None=None, perPage: int | None=None, page: int | None=None) -> dict:
...
def github_search_prs(query: str, owner: str | None=None, repo: str | None=None, sort: str | None=None, order: str | None=None, perPage: int | None=None, page: int | None=None) -> dict:
...
def github_get_commit(owner: str, repo: str, sha: str, detail: str | None=None, perPage: int | None=None, page: int | None=None) -> dict:
...
def github_list_commits(owner: str, repo: str, sha: str | None=None, path: str | None=None, author: str | None=None, since: str | None=None, until: str | None=None, perPage: int | None=None, page: int | None=None) -> dict:
...
def github_projects_get(method: str, owner: str | None=None, owner_type: str | None=None, project_number: int | None=None, field_id: int | None=None, item_id: int | None=None, fields: list[str] | None=None, status_update_id: str | None=None) -> dict:
...
def github_projects_list(method: str, owner: str, owner_type: str | None=None, project_number: int | None=None, query: str | None=None, fields: list[str] | None=None, per_page: int | None=None, after: str | None=None, before: str | None=None) -> dict:
