...
def edit_block(path: str, old_text: str, new_text: str, exact: bool=False) -> EditBlockResult:
    ...
    Raises:
        ...
        EditBlockError: If old_text not found or appears more than once in file.
