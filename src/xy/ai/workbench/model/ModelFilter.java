...
/**
 * Filters out non-mainstream model categories (image, video, audio, embedding,
 * moderation, ...).
 */
public final class ModelFilter {

	private static final Pattern BLACKLIST = Pattern
			.compile("(?i).*(dall-e|dalle|whisper|tts|speech|audio|embedding|moderation|realtime|transcri|image|video|" //
