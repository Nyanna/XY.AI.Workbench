...
- Function Names müssen Global eindeutig sein, keine Package Namespaces

## tool_search

Ein neues Tool "tool_search" in `/home/user/xyan/xy.ai.workbench/mcpc/src/xy/ai/mcpc/tools`.
- Als Eingabe eine Space separierte liste von Keywords (nur englisch), die mit dem Tool (zuerst Function Name, dann Docstring) abgeglichen wird.
...
- Die Docstrings aller registrierten Tools müssen überprüft und korrigiert werden.
	- Descriptive erste Zeile; ausreichend beschrieben; enthält notwendige Keywords.