...
# 3. Generic fallback deny – no redirect rule matched, tool is also not in the allow-list
block "Tool '$TOOLNAME' is neither allowed nor has a redirect rule. Abort and ask the user." "DENY"
