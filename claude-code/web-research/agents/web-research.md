...
tool_deny:
  redirect:
    ...
    Read: "Trying to read a file indicates your instructions aren't sufficient. Abort and report the error."
    Grep: "Trying to use grep indicates your instructions aren't sufficient. Abort and ask to provide the required information."
    Glob: "Trying to use glob indicates your instructions aren't sufficient. Abort and ask to provide the required information."
...
* Don't try to access URLs from Github; use the 'github-research:github-research' agent or advise the caller to use the agent directly